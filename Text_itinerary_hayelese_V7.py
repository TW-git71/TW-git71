...
# with open("Haylese_text_dspy_input_6", "w") as file:
#     file.write(Prompt)

# output_path = r"C:\Evoq\Text_to_Json_Haylise\Text_itinerary_dspy_V6\Haylese_text_dspy_Output_6.json"
...
# topK_passages = retriever(query1).passages
# print(topK_passages)
